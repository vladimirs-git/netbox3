...
objects = nb.ipam.vlan_groups.get(tag=["tag1", "tag2"])
...
objects = nb.ipam.vlan_groups.get(created=["2000-12-31T23:59:59Z", "2001-01-01T01:01:01Z"])
objects = nb.ipam.vlan_groups.get(last_updated=["2000-12-31T23:59:59Z", "2001-01-01T01:01:01Z"])
